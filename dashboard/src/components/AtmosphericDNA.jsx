    ...
    return (
        <div className="bg-surface rounded-xl p-4 shadow-lg border border-border">
            ...
            <div className="grid grid-cols-3 gap-2">
                <div className="bg-slate-800/50 p-2 rounded-lg text-center border border-slate-700/50">
                    <div className="flex justify-center mb-1 text-orange-400">
                        <Thermometer size={14} />
                    </div>
                    <div className="text-[10px] text-slate-400 mb-0.5 uppercase">Temp</div>
                ...
                <div className="bg-slate-800/50 p-2 rounded-lg text-center border border-slate-700/50">
                    ...
                    <div className="text-[10px] text-slate-400 mb-0.5 uppercase">Humidity</div>
                    <div className="text-sm font-bold text-white">
                ...
                <div className="bg-slate-800/50 p-2 rounded-lg text-center border border-slate-700/50">
                    ...
                    <div className="text-[10px] text-slate-400 mb-0.5 uppercase">Wind</div>
                    <div className="text-sm font-bold text-white">
